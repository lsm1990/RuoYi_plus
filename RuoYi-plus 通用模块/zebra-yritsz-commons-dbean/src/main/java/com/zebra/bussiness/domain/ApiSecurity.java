...
public class ApiSecurity extends BussinessEntity {
	...
	public String toString() {
		return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE).append("apiKey", getApiKey())
				.append("apiSecret", getApiSecret()).append("apiStatus", getApiStatus()).append("apiType", getApiType())
				.append("apiCreateTime", getApiCreateTime()).append("apiUpdateTime", getApiUpdateTime()).toString();
	}
}
